...
if [[ -z ${PATH_GCCARM} ]]; then
  OBJCOPY="/Applications/Simplicity Studio 2.app/Contents/Eclipse/developer/toolchains/gnu_arm/4.9_2015q3/bin/arm-none-eabi-objcopy"
...
if [[ -z ${PATH_SCMD} ]]; then
  COMMANDER="/Applications/Simplicity Studio 2.app/Contents/Eclipse/developer/adapter_packs/commander/Commander.app/Contents/MacOS/commander"
